// Функция addListeners добавляет обработчики событий на кнопки для запуска анимаций
...
// Функция fadeIn плавно отображает элемент за указанное время
...
// Функция move плавно перемещает элемент за указанное время
//@param element — HTMLElement, который надо анимировать
//@param duration — Продолжительность анимации в миллисекундах
...
// Функция scale плавно изменяет размер элемента за указанное время
//@param element — HTMLElement, который надо анимировать
//@param duration — Продолжительность анимации в миллисекундах
...
// Функция getTransform возвращает строку с трансформациями в зависимости от переданных параметров
